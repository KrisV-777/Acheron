...
Event OnPageReset(string page)
  ...
  If (page == "$Achr_General")
    ...
    AddToggleOptionST("hunterpridekillanim", "$Achr_HunterPrideKillAnim", GetSettingBool("bHunterPrideKillAnim"))
...
Event OnSelectST()
  ...
  ElseIf(s[0] == "hunterpridekillanim")
    Toggle("bHunterPrideKillAnim")
  ; --------------- Defeat
...
Event OnHighlightST()
  ...
  ElseIf(s[0] == "notifydestroy")
    SetInfoText("$Achr_NotifyDestroyHighlight")
  ElseIf(s[0] == "notifycolored")
  ...
  ElseIf(s[0] == "hunterpridekillanim")
    SetInfoText("$Achr_HunterPrideKillAnimHighlight")
  ; --------------- Defeat
  ElseIf(s[0] == "lethalessential")
